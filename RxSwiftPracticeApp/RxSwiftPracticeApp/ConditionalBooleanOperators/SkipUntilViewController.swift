...
class SkipUntilViewController: UIViewController {
    ...
    private var unblockButtonObservable = PublishSubject<Void>()
    ...
    private func configureDataBinding() {
        colorButtonObservable
            .skip(until: self.unblockButtonObservable)
            .subscribe(
    ...
    @objc private func unblockButtonTapped(_ button: UIButton) {
        ...
        self.unblockButtonObservable.onNext(())
    }
}
