//
//  FlatMapFirstViewController.swift
//  RxSwiftPracticeApp
//
...
class FlatMapFirstViewController: UIViewController {

    private var descLabel: UILabel = {
        let label = UILabel()
        label.text = "알파벳 출력 중에는 새로운 출력 요청이 무시됩니다"
    ...
    private func configureDataBinding() {
        numberObservable
            .flatMapFirst{ (number: Int) -> Observable<String> in
