...
class TakeLastViewController: UIViewController {

    let randomNumber = Int.random(in: 5...10)
    
    private lazy var descLabel: UILabel = {
        let label = UILabel()
        label.text = "뒤에서 \(randomNumber)번째 값부터 나옵니다"
